                ...
                <div className="row py-4">
                    <div className="col-md-4">
                        <div className="card shadow border-0 p-4">
                            ...
                            <p>Les petites actions créent de grands impacts. Tout commence et se termine avec chaque employé s'engageant à adopter des pratiques de travail plus sûres quotidiennement, garantissant ainsi leur retour chez eux en toute sécurité.</p>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="card shadow border-0 p-4">
